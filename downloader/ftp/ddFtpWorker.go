...
func CreateFtpDownloader() gen.SupervisorBehavior {
	return &downloaderFtpSup{}
}

type downloaderFtpSup struct {
	gen.Supervisor
}

func (*downloaderFtpSup) Init(args ...etf.Term) (gen.SupervisorSpec, error) {
