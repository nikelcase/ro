...
func CreateSmbDownloader() gen.SupervisorBehavior {
	return &downloaderSmbSup{}
}

type downloaderSmbSup struct {
	gen.Supervisor
}

func (*downloaderSmbSup) Init(args ...etf.Term) (gen.SupervisorSpec, error) {
