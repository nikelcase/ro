...
func CreateFtpObserver() gen.SupervisorBehavior {
	return &observerFtpSup{}
}

type observerFtpSup struct {
	gen.Supervisor
}

func (*observerFtpSup) Init(args ...etf.Term) (gen.SupervisorSpec, error) {
