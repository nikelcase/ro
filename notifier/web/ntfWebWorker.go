...
func CreateWebNotifier() gen.SupervisorBehavior {
	return &notifierWebSup{}
}

type notifierWebSup struct {
	gen.Supervisor
}

func (*notifierWebSup) Init(args ...etf.Term) (gen.SupervisorSpec, error) {
