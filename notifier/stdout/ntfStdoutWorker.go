...
func CreateStdoutNotifier() gen.SupervisorBehavior {
	return &notifierStdoutSup{}
}

type notifierStdoutSup struct {
	gen.Supervisor
}

func (*notifierStdoutSup) Init(args ...etf.Term) (gen.SupervisorSpec, error) {
