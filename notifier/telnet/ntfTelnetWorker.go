...
func CreateTelnetNotifier() gen.SupervisorBehavior {
	return &notifierTelnetSup{}
}

type notifierTelnetSup struct {
	gen.Supervisor
}

func (*notifierTelnetSup) Init(args ...etf.Term) (gen.SupervisorSpec, error) {
